...
- **Physikalische Validierung der Brechungsindex-Korrektur**: Die neue, an Besseling et al. angelehnte `calculate_advanced_refractive_correction`-Variante koppelt Basis-, Winkel- und Deckglas-Faktoren. Ein Abgleich mit Messdaten (z.B. PSFj oder Calibration Beads) sowie optionale Importfunktionen für empirische Kurven könnten verbleibende Unsicherheiten weiter reduzieren.【F:tiff_simulator_v3.py†L169-L235】
